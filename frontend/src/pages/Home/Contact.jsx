    ...
    <div className="w-full flex flex-col lg:flex-row gap-10 items-center justify-between py-8 lg:py-16">
      <div className="w-full lg:w-3/6">
        ...
        <p className="mb-4 text-center text-gray-500">
          Email: <a href="mailto:Info@newlondonhospitality.com" className="text-blue-500">Info@newlondonhospitality.com</a>
        </p>
        <p className="text-center text-gray-500">
          Address: 269 N Frontage Rd, New London, CT 06320
        </p>
      </div>
      <form
        action="#"
      ...
      >
        ...
        <button
          type="submit"
          className="py-3 px-5 text-sm font-medium text-center text-white rounded-lg bg-dark sm:w-fit hover:bg-opacity-80 focus:ring-4 focus:outline-none focus:ring-blue-300"
        >
          Send message
        </button>
      </form>
