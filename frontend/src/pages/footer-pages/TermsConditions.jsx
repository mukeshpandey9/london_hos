    ...
    <div className="px-6 lg:px-20 py-20 bg-slate-50">
      <div className="max-w-7xl mx-auto">
        ...
        <p className="text-slate-700 text-justify mb-5">
          Welcome to New London Hospitality. These terms and conditions outline
          the rules and regulations for the use of our website and services. By
          accessing our website and using our services, you accept and agree to
        ...
        <p className="text-slate-700 text-justify mb-5">
          ...
          images, and software, is the property of New London Hospitality or its
        ...
        <p className="text-slate-700 text-justify mb-5">
          New London Hospitality will not be liable for any direct, indirect,
          incidental, special, or consequential damages arising from the use or
          inability to use our services or from any information, products, or
          services obtained through our website. This limitation of liability
        ...
        <p className="text-slate-700 text-justify mb-5">
          ...
          following any changes indicates your acceptance of the new terms. It
