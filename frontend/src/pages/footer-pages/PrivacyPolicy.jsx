    ...
    <div className="px-6 lg:px-20 py-20 bg-slate-50">
      <div className="max-w-7xl mx-auto">
        ...
        <p className="text-slate-700 text-justify mb-5">
          At New London Hospitality, we are committed to protecting your
        ...
        <h2 className="text-2xl lg:text-3xl font-bold text-slate-700 text-justify mb-5">
          Inasdflkjasdfkformation Collection:
        </h2>
        <p className="text-slate-700 text-justify mb-5">
          We collect personal information that you voluntarily provide to us
          when you use our services, such as your name, email address, phone
          number, and payment information. We may also collect non-personal
        ...
        <p className="text-slate-700 text-justify mb-5">
          ...
          materials and updates about our services.
        </p>
        <h2 className="text-2xl lg:text-3xl font-bold text-slate-700 text-justify mb-5">
          Information Sharing:
        </h2>
        <p className="text-slate-700 text-justify mb-5">
          ...
          to outside parties without your consent, except as necessary to
          provide our services or comply with legal requirements. We may share
